				...
				<div class="box-list d-flex justify-content-center flex-wrap">
					<div class="box ml-3 mt-3">
						<div class="inner-box text-center">
							<a href="/lodging/lodginglist/view?area_name=seoul&sortType=" class="box-profile">
						...
						<div class="box-body d-flex justify-content-center align-items-center">
							<a href="/lodging/lodginglist/view?area_name=seoul&sortType=" class="font-weight-bold text-dark">서울</a>
						</div>
						<!-- 지역별 숙소 갯수 나타내기 옵션 -->
					</div>							
					...
					<div class="box ml-3 mt-3">
						<div class="inner-box text-center">
							<a href="/lodging/lodginglist/view?area_name=incheonl&sortType=" class="box-profile">
								<img class="profile my-3" width = "" src="https://cdn.pixabay.com/photo/2021/08/21/07/55/south-korea-6562089_960_720.jpg" alt="인천">
							</a>
						</div>
						<div class="box-body d-flex justify-content-center align-items-center">
							<a href="/lodging/lodginglist/view?area_name=incheon&sortType=" class="font-weight-bold text-dark">인천</a>
						</div>
					...
					<div class="box ml-3 mt-3">
						<div class="inner-box text-center">
							<a href="/lodging/lodginglist/view?area_name=gangwon&sortType=" class="box-profile">
								<img class="profile my-3" width = "" src="https://cdn.pixabay.com/photo/2015/09/26/05/07/mt-seoraksan-958643_960_720.jpg" alt="강원">
							</a>
						</div>
						<div class="box-body d-flex justify-content-center align-items-center">
							<a href="/lodging/lodginglist/view?area_name=gangwon&sortType=" class="font-weight-bold text-dark">강원</a>
						</div>
					</div>										
					...
					<div class="box ml-3 mt-3">
						<div class="inner-box text-center">
							<a href="/lodging/lodginglist/view?area_name=gyeongsang&sortType=" class="box-profile">
								<img class="profile my-3" width = "" src="https://cdn.pixabay.com/photo/2020/05/24/11/56/to-5213925_960_720.jpg" alt="경상">
							</a>
						</div>
						<div class="box-body d-flex justify-content-center align-items-center">
							<a href="/lodging/lodginglist/view?area_name=gyeongsang&sortType = ''" class="font-weight-bold text-dark">경상</a>
						</div>
					</div>
					...
					<div class="box ml-3 mt-3">
						<div class="inner-box text-center">
							<a href="/lodging/lodginglist/view?area_name=busan&sortType=" class="box-profile bg-info">
						...
						<div class="box-body d-flex justify-content-center align-items-center">
							<a href="/lodging/lodginglist/view?area_name=busan&sortType=" class="font-weight-bold text-dark">부산</a>
						</div>						
					</div>
