				...
				<div class="room-card-list">
					...
					<div class="room-card d-flex ml-3 mt-3">
						...
						<c:choose>
							...
							<a href="/lodging/reservation/view?id=${room.id }&lodgingId=${lodging.id}" class="btn btn-primary reserve-btn btn-sm mt-3 col-11" type="button" data-room-id="${room.id }">예약하기</a>
